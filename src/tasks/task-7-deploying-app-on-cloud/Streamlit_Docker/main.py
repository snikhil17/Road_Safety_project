...
if add_selectbox == 'Home':
    ...
    if st.button('submit'):
        ...
        if label == 'complaints' and sentiment == 'positive':
            st.write(f"Sentiment of Sentence: {sentiment} and Label of Sentence: Positive or General Detail")
        elif label == 'appreciation' and sentiment == 'negative':
            st.write(f"Sentiment of Sentence: {sentiment} and Label of Sentence: Negative Detail")
        else:
